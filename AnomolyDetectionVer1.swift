...
//        // Use shooting hand (assume right-handed for now)
...
//              wrist.confidence > 0.5 else { return nil }
//        
//        let shoulderPt = CGPoint(x: shoulder.location.x, y: shoulder.location.y)
//        let elbowPt = CGPoint(x: elbow.location.x, y: elbow.location.y)
//        let wristPt = CGPoint(x: wrist.location.x, y: wrist.location.y)
//        
//        // Calculate angle between upper arm and forearm
//        let upperArm = CGPoint(x: elbowPt.x - shoulderPt.x, y: elbowPt.y - shoulderPt.y)
//        let forearm = CGPoint(x: wristPt.x - elbowPt.x, y: wristPt.y - elbowPt.y)
//        
