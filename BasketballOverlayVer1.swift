...
//        
//        // Coaching feedback view
//        coachingFeedbackView.backgroundColor = UIColor.black.withAlphaComponent(0.9)
...
//        feedbackTimer = Timer.scheduledTimer(withTimeInterval: 5.0, repeats: false) { [weak self] _ in
//            UIView.animate(withDuration: 0.3) {
...
//        
//        // Draw shooting arm connections (assuming right-handed)
...
//        let jointDict = Dictionary(joints, uniquingKeysWith: { first, _ in first })
//        
//        // Update shooting hand label
//        if let wrist = jointDict[.rightWrist] {
//            shootingHandLabel.text = "🏀 SHOOTING HAND"
//        } else {
//            shootingHandLabel.text = ""
//        }
//        
//        // Update mechanics label with basic info
//        var mechanicsText = ""
